...
int main()
{
	...
	for (int i = 0; i <= 88; i = i + 1)
	{
		...
		case 0:
		{
			rHeight = "A" + std::to_string(height);
			break;
		}
		case 1:
		{
		...
		case 2:
		{
			rHeight = "B" + std::to_string(height);
			break;
		}
		case 3:
		{
			rHeight = "C" + std::to_string(height);
			break;
		}
		case 4:
		{
		...
		case 5:
		{
			rHeight = "D" + std::to_string(height);
			break;
		}
		case 6:
		{
		...
		case 7:
		{
			rHeight = "E" + std::to_string(height);
			break;
		}
		case 8:
		{
			rHeight = "F" + std::to_string(height);
			break;
		}
		case 9:
		{
		...
		case 10:
		{
			rHeight = "G" + std::to_string(height);
			break;
		}
		case 11:
		{
