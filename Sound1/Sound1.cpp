...
int main()
{
	...
	chord[27].set("D3 ", key[42], key[46], key[49]);
	chord[28].set("D#3 ", key[31], key[35], key[37]);
	chord[29].set("E3 ", key[32], key[36], key[39]);
	chord[30].set("F3 ", key[33], key[37], key[40]);
	chord[31].set("F#3 ", key[34], key[38], key[41]);
	chord[32].set("G3 ", key[35], key[39], key[42]);
	chord[33].set("G#3 ", key[36], key[40], key[43]);
	chord[34].set("A3 ", key[37], key[41], key[44]);
	chord[35].set("A#3 ", key[38], key[42], key[45]);
	chord[36].set("B3 ", key[39], key[43], key[46]);

	chord[37].set("C4 ", key[40+12], key[44+12], key[47+12]);
	chord[38].set("C#4 ", key[41+12], key[45+12], key[36+12]);
	chord[39].set("D4 ", key[42+12], key[46+12], key[49+12]);
	chord[40].set("D#4 ", key[31+12], key[35+12], key[37+12]);
	chord[41].set("E4 ", key[32+12], key[36+12], key[39+12]);
	chord[42].set("F4 ", key[33+12], key[37+12], key[40+12]);
	chord[43].set("F#4 ", key[34+12], key[38+12], key[41+12]);
	chord[44].set("G4 ", key[35+12], key[39+12], key[42+12]);
	chord[45].set("G#4 ", key[36+12], key[40+12], key[43+12]);
	chord[46].set("A4 ", key[37+12], key[41+12], key[44+12]);
	chord[47].set("A#4 ", key[38+12], key[42+12], key[45+12]);
	chord[48].set("B4 ", key[39+12], key[43+12], key[46+12]);

	chord[49].set("C5 ", key[40+24], key[44+24], key[47+24]);
	chord[50].set("C#5 ", key[41+24], key[45+24], key[36+24]);
	chord[51].set("D5 ", key[42+24], key[46+24], key[49+24]);
	chord[52].set("D#5 ", key[31+24], key[35+24], key[37+24]);
	chord[53].set("E5 ", key[32+24], key[36+24], key[39+24]);
	chord[54].set("F5 ", key[33+24], key[37+24], key[40+24]);
	chord[55].set("F#5 ", key[34+24], key[38+24], key[41+24]);
	chord[56].set("G5 ", key[35+24], key[39+24], key[42+24]);
	chord[57].set("G#5 ", key[36+24], key[40+24], key[43+24]);
	chord[58].set("A5 ", key[37+24], key[41+24], key[44+24]);
	chord[59].set("A#5 ", key[38+24], key[42+24], key[45+24]);
	chord[60].set("B5 ", key[39+24], key[43+24], key[46+24]);

	chord[61].set("C6 ", key[40+36], key[44+36], key[47+36]);
	chord[62].set("C#6 ", key[41+36], key[45+36], key[36+36]);
	chord[63].set("D6 ", key[42+36], key[46+36], key[49+36]);
	chord[64].set("D#6 ", key[31+36], key[35+36], key[37+36]);
	chord[65].set("E6 ", key[32+36], key[36+36], key[39+36]);
	chord[66].set("F6 ", key[33+36], key[37+36], key[40+36]);
	chord[67].set("F#6 ", key[34+36], key[38+36], key[41+36]);
	chord[68].set("G6 ", key[35+36], key[39+36], key[42+36]);
	chord[69].set("G#6 ", key[36+36], key[40+36], key[43+36]);
	chord[70].set("A6 ", key[37+36], key[41+36], key[44+36]);
	chord[71].set("A#6 ", key[38+36], key[42+36], key[45+36]);
	chord[72].set("B6 ", key[39+36], key[43+36], key[46+36]);
	
	chords[1].set("AM7 ", key[37], key[41], key[44], key [48]);
	chords[2].set("AD7 ", key[37], key[41], key[44], key [47]);
	chords[3].set("Bm7 ", key[37], key[40], key[44], key [47]);
	chords[4].set("Bd7 ", key[37], key[40], key[43], key [46]);
	chords[5].set("BM7 ", key[39], key[43], key[46], key [50]);
	chords[6].set("BD7 ", key[39], key[43], key[46], key [49]);
	chords[7].set("Bm7 ", key[39], key[42], key[46], key [49]);
	chords[8].set("Bd7 ", key[39], key[42], key[45], key [48]);
	chords[9].set("CM7 ", key[40], key[44], key[47], key [51]);
	chords[10].set("CD7 ", key[40], key[44], key[47], key [50]);
	chords[11].set("Cm7 ", key[40], key[43], key[47], key [50]);
	chords[12].set("Cd7 ", key[40], key[43], key[46], key [49]);
	chords[13].set("DM7 ", key[42], key[46], key[49], key [53]);
	chords[14].set("DD7 ", key[42], key[46], key[49], key [52]);
	chords[15].set("Dm7 ", key[42], key[45], key[49], key [52]);
	chords[16].set("Dd7 ", key[42], key[45], key[48], key [51]);
	chords[17].set("EM7 ", key[44], key[48], key[51], key [55]);
	chords[18].set("ED7 ", key[44], key[48], key[51], key [54]);
	chords[19].set("Em7 ", key[44], key[47], key[51], key [54]);
	chords[20].set("Ed7 ", key[44], key[47], key[50], key [53]);
	chords[21].set("FM7 ", key[45], key[49], key[52], key [56]);
	chords[22].set("FD7 ", key[45], key[49], key[52], key [55]);
	chords[23].set("Fm7 ", key[45], key[48], key[52], key [55]);
	chords[24].set("Fd7 ", key[45], key[48], key[51], key [54]);
	chords[25].set("GM7 ", key[47], key[51], key[54], key [58]);
	chords[26].set("GD7 ", key[47], key[51], key[54], key [57]);
	chords[27].set("Gm7 ", key[47], key[50], key[54], key [57]);
	chords[28].set("Gd7 ", key[47], key[50], key[53], key [56]);
